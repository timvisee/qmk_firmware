 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |L Ctrl| LGUI | LAltf|      |      |                                       |      | App  | RAlt | RGui | RCtrl|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | Home | End  |       | PGDN | PGUP   |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LCTRL,       KC_LGUI,      KC_LALT,        KC_LEFT,KC_TRNS,
                                               KC_HOME,       KC_END,
                                                              TG(SYMB),
        ...
        // right hand
             ...
             KC_RPRN,     KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          KC_BSLASH,
                                  KC_TRNS,KC_APP, KC_RALT,KC_RGUI,          KC_RCTRL,
             KC_PGDN,        KC_PGUP,
             TG(MDIA),
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS,KC_PERC,KC_CIRC,KC_LBRC,KC_RBRC,KC_TILD,DEBUG,
       ...
       DEBUG,   KC_AMPR, KC_1,   KC_2,    KC_3,    KC_BSLS, KC_TRNS,
